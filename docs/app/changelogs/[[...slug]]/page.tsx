  ...
  return (
    <div className="grid md:grid-cols-2 items-start">
      ...
      <div className="px-4 relative md:px-8 pb-12 md:py-12">
        <div className="absolute top-0 left-0 h-full -translate-x-full w-px bg-linear-to-b from-black/5 dark:from-white/10 via-black/3 dark:via-white/5 to-transparent"></div>
        <Link
          href="/changelogs"
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "website",
      url: absoluteUrl(`changelogs/${pageSlug}`),
      images: [
        {
          url: url.toString(),
          width: 1200,
